...
package com.school.xnew.redis.impl;
...
import org.lost.finder.util.JSONUtil;
...
public class RCacheRepository implements CacheRepository, InitializingBean {
	...
	@Resource
	@Value(value = "${COM.redis.ip}")
	private String				ip;
	@Resource
	@Value(value = "${COM.redis.port}")
	private Integer				port;
	private static JedisPool	pool;
	@Resource
	@Value(value = "${COM.redis.maxActive}")
	private Integer				maxActive;
	@Resource
	@Value(value = "${COM.redis.maxIdle}")
	private Integer				maxIdle;
	@Resource
	@Value(value = "${COM.redis.maxWait}")
	private Long				maxWait;
	@Resource
	@Value(value = "${COM.redis.time}")
	private Long				time;
