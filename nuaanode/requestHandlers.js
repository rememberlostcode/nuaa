        ...
        client.get(key, function(err, res) {
            ...
            if(newsdetail){
                ...
                var options = {
                    ...
                    path: "/solr/collection1/select?wt=json&sort=time+asc&rows=1" + param,
                    headers:{
                    ...
                    try{
                        ...
                        res.on('data', function (chunk) {
                            ...
                            var options2 = {
                                host: solr_server_host,
                                port: solr_server_port,
                                path: "/solr/collection1/select?q=type%3A"+type+"&wt=json&sort=time+desc&rows=1" + param,
                                headers:{
                                    "Content-Type": applicationJson,
                                    "User-Agent": UserAgent
                                }
...
function newslist(query,response) {
    ...
    var options = {
        host: solr_server_host,
        port: solr_server_port,
        path: "/solr/collection1/select?q=type%3A0&wt=json&sort=time+desc" + param,
        headers:{
            "Content-Type": applicationJson,
            "User-Agent": UserAgent
        }
...
function noticelist(query,response) {
    ...
    var options = {
        host: solr_server_host,
        port: solr_server_port,
        path: "/solr/collection1/select?q=type%3A1&wt=json&sort=time+desc" + param,
        headers:{
            "Content-Type": applicationJson,
            "User-Agent": UserAgent
        }
...
function searchlist(query,response) {
    ...
    var options = {
        host: solr_server_host,
        port: solr_server_port,
        path: "/solr/collection1/select?wt=json&hl=true&hl.fl=news_title&sort=time+desc&q=news_title%3A"+encodeURIComponent(keywords)+param,
        headers:{
            "Content-Type": applicationJson,
            "User-Agent": UserAgent
        }
