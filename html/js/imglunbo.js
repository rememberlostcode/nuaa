var PImgPlayer = {
	...
	init: function(objID, w, h, time) {
		...
		//  
		var html = "<a href=\"" + this._items[this._index].link + "\" title=\"" + this._items[this._index].title + "\" target=\"_blank\" style=\"" + linkStyle + "\"></a>";
		this._container.innerHTML = html;
		var link = this._container.getElementsByTagName("A")[0];
		link.style.width = w + "px";
		link.style.height = h + "px";
		link.style.background = 'url(' + this._items[0].img + ') no-repeat left top';
		//  
	...
	play: function(index) {
		...
		link.style.background = 'url(' + this._items[this._index].img + ') no-repeat left top';
		//  
		var liStyle = "margin:0;list-style-type: none; margin:0;padding:0; float:right;";
		var baseSpacStyle = "clear:both; display:block; width:20px;line-height:32px; font-size:10px; FONT-FAMILY:'Verdana';/*opacity: 0.6;*/";
		baseSpacStyle += "border:0px solid #fff;border-right:0;border-bottom:0;";
