var PImgPlayer = {  
        ...
        init : function( objID, w, h, time ){  
                ...
                //  
                var ulStyle = "background-color:#385165;opacity: 0.8;margin:0 0 0 0;width:"+w+"px;position:absolute;z-index:999;right:0px;FILTER:Alpha(Opacity=50,FinishOpacity=50, Style=1);overflow: hidden;bottom:-1px;height:32px; border-right:0px solid #fff;";  
                //  
                var liStyle = "margin:0;list-style-type: none; margin:0;padding:0; float:right;width:auto;";  
                //  
